...
}{O autor}{fig:bijetividade}{}{Função bijetiva $f(x)$, sua inversa $f^{-1}(x)$ e a composição $f^{-1}(f(x))$ representadas através de conjuntos.}
...
}{O autor}{fig:dpd_cascata}{}{Cascata do DPD com o PA ilustrando as distorções sofridas pelo sinal de entrada, no qual o sinal intermediário é desconhecido.}


\imagem{Cascata do PA com o PoD}{
\resizebox{0.8\textwidth}{!}{
...
}{O autor}{fig:pod_cascata}{}{Cascata do PA com o PoD ilustrando as distorções sofridas pelo sinal de entrada, no qual o sinal intermediário é a saída conhecida do PA.}
