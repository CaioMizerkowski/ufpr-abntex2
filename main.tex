...
\usetikzlibrary{shapes.geometric,decorations.pathmorphing,patterns}
\usetikzlibrary{arrows}
\usetikzlibrary{positioning}

\tikzset{input/.style={draw}}
\tikzset{weights/.style={draw, circle, inner sep = 0em,minimum size = 2em}}
\tikzset{functions/.style={draw, rounded rectangle, inner sep = 0.5em,minimum size = 2em}}
